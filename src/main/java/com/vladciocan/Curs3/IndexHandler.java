...
public class IndexHandler  implements HttpHandler {
	public void handle(HttpExchange t) throws IOException {
        ...
        String response = "<html>\r\n" + 
        		...
        		"    <input onclick=\"window.location.href = 'localhost:8001/login';\"type=\"submit\" value=\"Inregistreaza un utilizator nou\">\r\n" + 
        		"        \r\n" + 
        		"    \r\n" + 
        		"    </form>\r\n" + 
        		"    <p>-SAU-</p>\r\n" + 
        		"    <span>\r\n" + 
        		"        <a hreff=\"/login\"><input type=\"button\" name=\"Button\" value=\"Du-te la login\"/></a></span>\r\n" + 
        		"</body>\r\n" + 
        		"\r\n" + 
        		"</html>";
